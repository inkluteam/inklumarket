    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
        <div className="card p-6">
          ...
          <p className="text-3xl font-bold text-emerald-600">{formatMoney(totalRevenue)}</p>
        ...
        <div className="card p-6">
          ...
          <p className="text-3xl font-bold text-blue-600">{formatMoney(totalFees)}</p>
          <p className="text-xs text-gray-400 mt-1">Revenue from commissions</p>
        </div>
        <div className="card p-6">
          <p className="text-sm text-gray-500">Seller Payouts</p>
          <p className="text-3xl font-bold text-purple-600">{formatMoney(totalPayouts)}</p>
            ...
            <tbody className="divide-y divide-gray-100">
              {transactions.map((t) => (
                <tr key={t.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-sm text-purple-600">{formatMoney(t.sellerPayout)}</td>
