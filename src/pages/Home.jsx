        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6">
              ...
              <span className="text-emerald-300">Empower Everyone.</span>
            </h1>
            <p className="text-lg md:text-xl text-blue-100 mb-8 leading-relaxed">
              Discover unique, high-quality products from disability-led enterprises. Every purchase creates opportunities and builds a more inclusive economy.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link to="/catalog" className="inline-flex items-center gap-2 bg-white text-blue-700 px-8 py-4 rounded-lg font-bold text-lg hover:bg-blue-50 transition-colors">
      ...
      <section className="bg-white py-8 border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            ...
            <div className="flex flex-col items-center gap-2">
              <Truck className="w-8 h-8 text-emerald-600" aria-hidden="true" />
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center mb-12">
              ...
              <Link to="/catalog" className="text-blue-600 hover:text-blue-700 font-semibold flex items-center gap-1">
      ...
      <section className="bg-emerald-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-emerald-100 mb-8 max-w-2xl mx-auto">
            Join our growing community of conscious consumers and empowered sellers. Together, we build a marketplace where everyone belongs.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/register" className="bg-white text-emerald-600 px-8 py-4 rounded-lg font-bold text-lg hover:bg-emerald-50 transition-colors">
              Create Account
            </Link>
